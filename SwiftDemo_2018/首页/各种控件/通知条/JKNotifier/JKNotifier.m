...
- (JKNotifierBar*)showNotifer:(NSString*)note name:(NSString*)appName icon:(UIImage*)appIcon{
    ...
    self.notifierBar.backgroundColor = [UIColor clearColor];
    self.notifierBar.layer.cornerRadius = 10;
    self.notifierBar.layer.masksToBounds = YES;
    CGRect frame = _notifierBar.frame;
    frame.origin.x = 10.;
    frame.size.width = [UIScreen mainScreen].bounds.size.width - 20.;
    self.notifierBar.frame = frame;
